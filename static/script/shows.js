...
import {clearElement, openModal} from "./dom.js";
...
function displayShowsTable(way=0) {
    ...
    postData('/page', pageNumber, checkShowsData);
    return showsParameters.offsetForShows
}

// ----- validate data from server and inform user if there is error ----
function checkShowsData(data) {
    if(data['shows'] === 'error'){
